...
const HowItWorkCard = ({ description, image, num, title }: Props) => {
  return <div>
    <div className='relative'>
        <Image src={image} alt='img' width={250} height={250}
        ...
        <p className='mt-4 text-base font-bold text-blue-800 hover:text-blue-600 transition-all duration-150 cursor-pointer text-center'>Start Earning &rarr;</p>
