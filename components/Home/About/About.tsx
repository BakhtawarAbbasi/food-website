      ...
      <div className='w=[80%] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-10 items-center'>
        ...
        {/* Text Content */}
         <div>
            ...
            <p className='mt-4 leading-6 sm:leading-8 text-gray-800 dark:text-gray-300 font-medium text-sm sm:text-base'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Neque nisi facere id.</p>
            <div className='mt-8'>
              <div className='flex mt-8 items-center space-x-6'>
                ...
                <div>
                  ...
                  <p className='mt-2 text-gray-800 dark:text-gray-300 font-medium text-sm sm:text-base'>We're driven beyond finish the project we want to find solutions using our website & apps</p>
                </div>
              </div>
            </div>
            ...
            <div className='mt-8'>
              <div className='flex mt-8 items-center space-x-6'>
                ...
                <div>
                  <h1 className='text-base sm:text-lg font-extrabold '>Deliver food within30 minute</h1>
                  <p className='mt-2 text-gray-800 dark:text-gray-300 font-medium text-sm sm:text-base'>We're driven beyond finish the project we want to find solutions using our website & apps</p>
                </div>
              </div>
            </div>
