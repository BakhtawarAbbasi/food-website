...
const ReviewCard = ({ reviewTitle, role, userImage, userName }: Props) => {
  return (
    <div className='bg-gray-100 dark:bg-gray-900 p-6 rounded-lg mr-4 shadow-md'>
      ...
      <p className='mt-4 text-base font-medium text-gray-800 dark:text-gray-300'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Amet dignissimos odio porro quis libero eum cum! Dolores perferendis recusandae illo?</p>
